...
**Use Vercel Hobby instead.** Hobby is **$0**, for personal projects, and does not sleep — the first tap after a quiet stretch may take a second, but there is no interstitial.
...
3. Start: `npm start`
4. Node 22
5. `VITE_AUTH_ENABLED=false`, `GEMINI_API_KEY`, `NPM_CONFIG_PRODUCTION=false`
