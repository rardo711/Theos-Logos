...
const EN = {
  ...
  quickJumpPlaceholder: "John 1:1, Word, Rom 8…",
  jumpToReference: "Jump to {reference}",
  allSavedSources: "All saved sources",
  sourcesOnDevice: "Sources on this device",
  sourcesOnDeviceDesc: "Historic commentaries and study notes saved locally.",
  backToScripture: "Back to Scripture",
  readInScripture: "Read in Scripture",
  filterSources: "Filter by author, book, or keyword…",
  noSavedSources: "No commentaries saved on this device yet.",
  sourcesCount: "{count} commentaries",
  filterAll: "All",
...
const ES: { [K in keyof typeof EN]: string } = {
  ...
  quickJumpPlaceholder: "Juan 1:1, Verbo, Rom 8…",
  jumpToReference: "Ir a {reference}",
  allSavedSources: "Todas las fuentes guardadas",
  sourcesOnDevice: "Fuentes en este dispositivo",
  sourcesOnDeviceDesc: "Comentarios históricos y notas de estudio guardados localmente.",
  backToScripture: "Volver a la Escritura",
  readInScripture: "Leer en la Escritura",
  filterSources: "Filtrar por autor, libro o palabra clave…",
  noSavedSources: "No hay comentarios guardados en este dispositivo aún.",
  sourcesCount: "{count} comentarios",
  filterAll: "Todas",
